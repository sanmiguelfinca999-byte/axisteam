...
export const CORONEL_CREDENTIALS = {
  id: 'LEAD',                // necesario para Solo Mode (las misiones se asignan a este id)
  username: 'coronel',
  password: 'nexus2024',
  ...
  rolLabel: 'Lead',
  avatar: '◆',
  especialidad: 'Lead / Orchestrator',
}
...
export const SEED_TASKS = [
  ...
  // A11 — Valentina Luna (GHOST) — FORZAR CRISIS para demostrar Protocolo Charlie
  ...
  mkTask('A11', 'Extracción urgente — Nodo Echo-4', 'Activo en zona caliente requiere salida inmediata vía corredor 7', 'CRITICA', 0, -2, { storyPoints: 13 }),
  mkTask('A11', 'Documentar contactos comprometidos', 'Lista urgente de contactos quemados tras la operación Sierra', 'CRITICA', 5, -1, { storyPoints: 8 }),

  // ---- Tareas adicionales para demostrar CRISIS en SPECTRE (A05) ----
  mkTask('A05', 'Respuesta a brecha — Sistema Aurora', 'Brecha detectada hace 6h, contener y forensia urgente', 'CRITICA', 0, -1, { storyPoints: 13 }),
  mkTask('A05', 'Análisis malware variante Zeta-7', 'Reverse engineering de payload encontrado en honeypot — atraso 3 días', 'CRITICA', 10, -3, { storyPoints: 8 }),
]
