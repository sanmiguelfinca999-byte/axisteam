...
const LEVEL_STYLES = {
  CHARLIE: { border: 'border-red-500',    bg: 'bg-red-900/20',    dot: 'bg-red-500',    text: 'text-red-400',    label: 'BLOQUEO',    pulse: true  },
  BRAVO:   { border: 'border-yellow-500', bg: 'bg-yellow-900/10', dot: 'bg-yellow-500', text: 'text-yellow-400', label: 'SOBRECARGA', pulse: false },
  NOMINAL: { border: 'border-nexus-border', bg: '',                dot: 'bg-nexus-green', text: 'text-nexus-green', label: 'EN MARCHA', pulse: false },
}
    ...
    <div onClick={handleClick} onKeyDown={handleKey} role="button" tabIndex={0}
      ...
      <div className="flex items-center justify-between">
        ...
        {activo.alertLevel === 'CHARLIE' && (
          <button onClick={handleCrisis} aria-label={`Re-route de misiones de ${activo.codename}`}
